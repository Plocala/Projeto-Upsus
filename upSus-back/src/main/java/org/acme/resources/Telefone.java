...
public class TelefoneResource {
    ...
    @Inject TelefoneServiceImpl autorMangaService;
    ...
    @POST
    public Response create(TelefoneDTO autorManga) {
        return Response.status(Status.CREATED).entity(autorMangaService.create(autorManga)).build();
    }

    @PUT
    @Path("/{id}")
    public Response update(@PathParam("id") long id, TelefoneDTO autorManga) {
